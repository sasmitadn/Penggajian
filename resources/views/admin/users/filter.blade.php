...
<div class="offcanvas offcanvas-end" tabindex="-1" id="filterSidebar">
    ...
    <div class="offcanvas-body">
        <form action="{{ route('admin.users.index') }}" method="get" id="filterForm">
            ...
            <x-form-default name="email" old="{{ $request->email }}" label="Email" type="email" />
            <x-form-search class="mb-3" name="id_category" label="Jabatan" selected="{{ $request->id_category }}"
            ...
            <div class="form-group row">
                <div class="col">
                    <button type="button" class="btn btn-outline-primary w-100"
                        onclick="window.location='{{ route('admin.users.index') }}'">Hapus Filter</button>
                </div>
                <div class="col">
