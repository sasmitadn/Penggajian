            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="invoice-wrapper">
                        <div class="intro">
                            Halo, <strong>{{ $model->user->name }}</strong>,
                            <br>
                            Ini adalah bukti pembayaran untuk tagihan <strong>{{ $model->parent->description }}</strong> sebesar
                        ...
                        <div class="payment-info">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <span>Tanggal</span>
                                    <strong>{{ $model->created_at->translatedFormat('d M Y h:i') }}</strong>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="line-items">
                            ...
                            <div class="items">
                                <div class="row item">
                                    <div class="col-xs-4 desc">
                                        {{ $model->parent->description }}
                                    </div>
                                    <div class="col-xs-3 qty">
                                        @if ($model->parent->is_credit == 1)
                                            Kredit
                                        @else
                                            Sekali Bayar
                                        @endif
                                ...
                                @if ($model->parent->is_credit == 1)
                                    ...
                                    {{-- <div class="row item">
                                        ...
                                        <div class="col-xs-3 qty">
                                            Pembayaran berhasil sebanyak {{ count($transactions) }} kali dari {{ $total }} tagihan {{ $modal->description }}.
                                        </div>
                                    </div> --}}
                                @else
                                    <div class="row item">
                            ...
                            <div class="total text-right">
                                ...
                                <div class="field">
                                    Nama <span>{{ $model->user->name }}</span>
                                </div>
                                <div class="field">
                                    Jabatan <span>{{ $model->user->category->name }}</span>
                                </div>
